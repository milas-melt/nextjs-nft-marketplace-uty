...
export default function NFTBox({price, nftAddress, tokenId, marketplaceAddress, seller}) {
    ...
    async function updateUI() {
        ...
        // cheating a little here ... not everybody has IPFS companion, not every browser is IPFS compatible. --> IPFS Gateway
        if (tokenURI) {
            // IPGS Gateway: A server that will return IPFS files from a "normal" URL. (to make https:// calls).
            ...
            // How can we simplify this? 3 (main) ways ...
            // 1. We could render images on our server, and just call our server
